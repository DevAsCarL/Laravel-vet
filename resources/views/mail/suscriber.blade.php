                        ...
                        <tr>
                            <td style="padding:40px 30px 30px 30px;text-align:center;font-size:24px;font-weight:bold;">
                                <a href="{{url('/')}}" style="text-decoration:none;">
                                    <img
                                        src="https://cdn.pixabay.com/photo/2021/01/05/22/01/paw-5892565_960_720.png" width="165" alt="Logo"
                                        style="width:100px;max-width:80%;height:auto;border:none;text-decoration:none;color:#ffffff;"></a>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                <h1
                                    style="text-align:center; margin:0 auto;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">
                                    Gracias por suscribirte!</h1>
                        ...
                        <tr>
                            <td style="padding:0;font-size:24px;line-height:28px;font-weight:bold;">
                                <a href="{{url('/')}}" style="text-decoration:none;"><img
                                        src="https://assets.codepen.io/210284/1200x800-2.png" width="600"
                                        alt=""
                ...
                <![endif]-->
                        ...
                        <tr>
                            <td
                                ...
                                <a href="{{url('/')}}" style="text-decoration:none;"><img
                                        src="https://assets.codepen.io/210284/1200x800-1.png" width="540"
                                        alt=""
                        ...
                        <tr>
                            <td
                                ...
                                <p style="margin:0;font-size:14px;line-height:20px;">&reg; Someone, Somewhere 2022<br><a
                                        class="unsub" href="{{url('/')}}"
