    ...
    <div id="app" class="grid">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <form id="manage-form" action="{{ route('manage.index') }}" method="get" class="d-none">
                                        @csrf
                                    </form>
        ...
        <div class="footer container-fluid bg-dark text-light">
            ...
            <div class="d-flex justify-content-around pt-4 mt-4 border-top">
                ...
                <li class="ms-3"><a class="img-icon" href="#"><svg class="bi" width="24" height="24"><use xlink:href="#twitter"></use></svg></a></li>
                <li class="ms-3"><a class="img-icon" href="#"><svg class="bi" width="24" height="24"><use xlink:href="#instagram"></use></svg></a></li>
                <li class="ms-3"><a class="img-icon" href="#"><svg class="bi" width="24" height="24"><use xlink:href="#facebook"></use></svg></a></li>
                </ul>
            </div>
            </footer>
        </div>
