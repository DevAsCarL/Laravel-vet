...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // create permissions
        Permission::create(['name' => 'show users'])->syncRoles($role1,$role2,$role3);
        ...
        Permission::create(['name' => 'show pet'])->syncRoles($role1,$role2,$role3);
        ...
        Permission::create(['name' => 'show services'])->syncRoles($role1,$role2,$role3);
